...
function n_different_tests = testFunction_for_Classifier_4(teamName)
        ...
        for direc=randperm(8)
            ...
            for t=times
                ...
                if nargout('positionEstimator') == 2
                    [angle, newParameters] = positionEstimator_4(past_current_trial, modelParameters);
                    modelParameters = newParameters;
                elseif nargout('positionEstimator') == 1
                    [angle] = positionEstimator_4(past_current_trial, modelParameters);
                end
