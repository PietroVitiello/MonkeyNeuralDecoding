...
function n_different_tests = testFunction_for_Classifier_9(teamName)
...
for test = 1:n_different_tests
    ...
    % Train Model
    modelParameters = positionEstimatorTraining_9(trainingData);
        ...
        for direc=randperm(8)
            ...
            for t=times
                ...
                if nargout('positionEstimator') == 2
                    [angle, newParameters] = positionEstimator_9(past_current_trial, modelParameters);
                    modelParameters = newParameters;
                elseif nargout('positionEstimator') == 1
                    [angle] = positionEstimator_9(past_current_trial, modelParameters);
                end
