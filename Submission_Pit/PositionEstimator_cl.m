classdef PositionEstimator_cl
    ...
    methods
        ...
        function usable_data = apply_ferromagnetico_2(~, data, lag, bin_size)
            ...
            usable_data = zeros(n_n, n_bin);
            for i = 1:n_bin
                usable_data(:, i) = sum(data(:,bin_starts(i):bin_starts(i)+bin_size-1)...
        ...
        function [state0, eeg_train, eeg_test, x_train, x_test] = ferromagnetico_2(~, trial, lag, bin_size, order, percent, start)
            %{
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
